...
! function (t, e) {
    ...
    function D(t) {
        var n = this;
        return this.length = 0, t && (A(t, function (t, e) {
            n[t] = e
    ...
    var R, H = ((R = function (t) {
            ...
            if (f(t)) return /complete|loaded|interactive/.test(document.readyState) && document.body ? t.call(document, R) : document.addEventListener("DOMContentLoaded", function () {
            ...
            if (E(t)) {
                ...
                if (!("#" === t[0] && !t.match(/[ .<>:~]/))) return new D(document.querySelectorAll(t));
    ...
    function V(s, t, r, a) {
        ...
        t ? t.split(" ").forEach(function (t) {
            var e, n, i, o;
            t && (e = s, n = r, i = a, o = U(t), (q[Y(e)] || []).filter(function (t) {
    ...
    function J(n, t) {
        ...
        return e.unshift(t), A(e, function (t, e) {
            A(e, function (t, e) {
                O(e) || (n[t] = e)
            })
        }), n
    ...
    H.ajax = function (t) {
        ...
        function $(t, e, n) {
            ...
            w && H(document).trigger(t, e), n && (n in G && (i = G[n].apply(G, s)), c[n] && (o = c[n].apply(c, s)), "beforeSend" !== n || !1 !== i && !1 !== o || (a = !0))
        }
        return !d || !Z(l) && !o || E(d) || d instanceof ArrayBuffer || d instanceof Blob || d instanceof Document || d instanceof FormData || (d = K(d)), d && Z(l) && (i = tt(i, d), d = null), new Promise(function (t, e) {
            Z(l) && !f && (i = tt(i, "_=" + Date.now()));
            var o, s = new XMLHttpRequest;
            s.open(l, i, h, p, m), (x || d && !Z(l) && !1 !== x) && s.setRequestHeader("Content-Type", x), "json" === b && s.setRequestHeader("Accept", "application/json, text/javascript"), v && A(v, function (t, e) {
                O(e) || s.setRequestHeader(t, e + "")
            }), /^([\w-]+:)?\/\/([^/]+)/.test(i) && RegExp.$2 !== window.location.host || s.setRequestHeader("X-Requested-With", "XMLHttpRequest"), g && A(g, function (t, e) {
                s[t] = e
                ...
                if (i)
                    if (r = 204 === s.status || "HEAD" === l ? "nocontent" : 304 === s.status ? "notmodified" : "success", "json" === b) {
                        try {
                            ...
                            $(Q.ajaxError, u, "error", s, r = "parsererror"), e(new Error(r))
                        }
                        "parsererror" !== r && ($(Q.ajaxSuccess, u, "success", n, r, s), t(n))
                    } else n = "HEAD" === l ? void 0 : "text" === s.responseType || "" === s.responseType ? s.responseText : s.response, u.data = n, $(Q.ajaxSuccess, u, "success", n, r, s), t(n);
                ...
                o && clearTimeout(o), $(Q.ajaxError, u, "error", s, s.statusText), $(Q.ajaxComplete, u, "complete", s, "error"), e(new Error(s.statusText))
            }, s.onabort = function () {
                var t = "abort";
                o && (t = "timeout", clearTimeout(o)), $(Q.ajaxError, u, "error", s, t), $(Q.ajaxComplete, u, "complete", s, t), e(new Error(t))
            }, $(Q.ajaxStart, u, "beforeSend", s), a ? e(new Error("cancel")) : (0 < C && (o = setTimeout(function () {
                s.abort()
            }, C)), s.send(d))
        })
    ...
    function it(t, e, n) {
        var i;
        return x(e) ? (nt(t, e), e) : O(n) ? O(e) ? t[et] ? t[et] : {} : (e = w(e), t[et] && e in t[et] ? t[et][e] : void 0) : (nt(t, ((i = {})[e] = n, i)), n)
    }
    ...
    function st(e, t) {
        if (e[et]) {
            ...
            O(t) ? (e[et] = null, delete e[et]) : E(t) ? t.split(" ").filter(function (t) {
                return t
            }).forEach(function (t) {
                return n(t)
            }) : A(t, function (t, e) {
    ...
    H.data = it, H.each = A, H.extend = function () {
    ...
    }, H.map = ot, H.merge = F, H.param = K, H.removeData = st, H.unique = rt, H.fn.add = function (t) {
        ...
        return x(t) ? (A(t, function (t, e) {
            i.off(t, n, e)
        }), this) : (!1 !== n && !f(n) || (e = n, n = void 0), !1 === e && (e = j), this.each(function () {
            V(this, t, e, n)
        }))
    }, H.fn.on = function (t, n, i, e, o) {
        var s = this;
        if (x(t)) return E(n) || (i = i || n, n = void 0), A(t, function (t, e) {
            s.on(t, n, i, e, o)
        }), this;
        if (null == i && null == e ? (e = n, i = n = void 0) : null == e && (E(n) ? (e = i, i = void 0) : (e = i, i = n, n = void 0)), !1 === e) e = j;
        ...
        return this.each(function () {
            ! function (s, t, r, a, u) {
                ...
                q[c] || (q[c] = []);
                var l = !1;
                x(a) && a.useCapture && (l = !0), t.split(" ").forEach(function (t) {
                    if (t) {
                        var n = U(t),
                            e = {
                                type: n.type,
                    ...
                    function o(e) {
                        e._ns && !X(e._ns).test(n.ns) || (e._data = a, u ? H(s).find(u).get().reverse().forEach(function (t) {
        ...
        var i = !1;
        if (f(n)) return this.each(function (t, e) {
            n.call(e, t, e) && (i = !0)
        }), i;
        ...
        H.fn[t] = function () {
            ...
            return this.each(function (t, e) {
                ...
                })), (n = H(s))[u ? "after" : "before"].apply(n, r), o || e.removeChild(s)
            })
        }
        ...
        H.fn[r] = function (n, i) {
            var o = this;
            if (x(n)) return A(n, function (t, e) {
                o[r](t, e)
            }), this;
                ...
                ! function (t, e, n) {
                    if (!O(n)) switch (s) {
                        ...
                        case 1:
                            ...
                            break;
                        default:
                            e = w(e), t.style[e] = p(n) ? n + (-1 < M.indexOf(e) ? "" : "px") : n
                    }
    ...
    function lt(e, n, t, i, o, s) {
        ...
        return 2 === i && o && (t += r("margin")), _(e) ? (window.document.documentMode && 1 === s && (t += r("border"), t += r("padding")), 0 === i && (t -= r("border")), 1 === i && (t -= r("border"), t -= r("padding"))) : (0 === i && (t += r("padding")), 2 === i && (t += r("border"), t += r("padding"))), t
    }
    ...
    H.fn.data = function (t, e) {
        ...
        if (f(n)) return this.map(function (t, e) {
                    ...
                    return function (t, e, n, i, o, s) {
                        ...
                        if (null != r) {
                            ...
                            if (-1 < ["auto", "inherit", ""].indexOf(r)) a.css(u, r);
                                ...
                                r = lt(t, n, parseFloat(r), i, o, -1) + (c || "px"), a.css(u, r)
                            }
                        }
                    }(e, t, s, o, i, n)
        ...
        return this.map(function () {
            for (var t = this.offsetParent; t && "static" === H(t).css("position");) t = t.offsetParent;
        ...
        if (this.length) {
            ...
            if ("fixed" === e.css("position")) t = e[0].getBoundingClientRect();
                ...
                (n = i.offset()).top += ht(i, "border-top-width"), n.left += ht(i, "border-left-width")
            }
            return {
        ...
        return this.each(function (t, e) {
            var n = i;
            f(n) ? n = n.call(e, t, e.innerHTML) : t && !E(n) && (n = H(n).clone()), H(e).before(n)
        }), this.remove()
    ...
    H.fn.show = function () {
        return this.each(function () {
            var t, e, n;
            "none" === this.style.display && (this.style.display = ""), "none" === I(this, "display") && (this.style.display = (t = this.nodeName, pt[t] || (e = document.createElement(t), document.body.appendChild(e), n = I(e, "display"), e.parentNode.removeChild(e), "none" === n && (n = "block"), pt[t] = n), pt[t]))
        })
        ...
        return p(t) && (t += "ms"), this.each(function () {
        ...
        function o(t) {
            t.target === this && (e.call(this, t), A(i, function (t, e) {
                n.off(e, o)
            }))
        }
    ...
    function vt(t, e, n, i) {
        ...
        o || it(i, "_mdui_mutation", o = []), -1 === o.indexOf(t) && (o.push(t), e.call(i, n, i))
    }
    H.fn.mutation = function () {
        return this.each(function (t, e) {
            var o = H(e);
            A(mt, function (n, i) {
                o.is(n) && vt(n, i, t, e), o.find(n).each(function (t, e) {
                    vt(n, i, t, e)
                })
            })
        })
        ...
        e.length ? (e.data("_overlay_is_deleted", !1), O(t) || e.css("z-index", t)) : (O(t) && (t = 2e3), e = H('<div class="mdui-overlay">').appendTo(document.body).reflow().css("z-index", t));
    ...
    H.guid = function (t) {
        ...
        O(n) || O(i) ? H(document).mutation() : (mt[n] = i, H(n).each(function (t, e) {
            return vt(n, i, t, e)
        }))
    };

    function bt(t, e) {
        void 0 === e && (e = {}), this.options = J({}, xt), this.state = "pinned", this.isEnable = !1, this.lastScrollY = 0, this.rafId = 0, this.$element = H(t).first(), J(this.options, e);
    ...
    bt.prototype.onScroll = function () {
        ...
        var t = this;
        this.isEnable || (this.isEnable = !0, this.state = "pinned", this.$element.addClass(this.options.initialClass).removeClass(this.options.pinnedClass).removeClass(this.options.unpinnedClass), this.lastScrollY = window.pageYOffset, B.on("scroll", function () {
            return t.onScroll()
        }))
    }, bt.prototype.disable = function () {
        var t = this;
        this.isEnable && (this.isEnable = !1, this.$element.removeClass(this.options.initialClass).removeClass(this.options.pinnedClass).removeClass(this.options.unpinnedClass), B.off("scroll", function () {
            return t.onScroll()
    ...
    function $t(t, e) {
        ...
        this.classItem = n, this.classItemOpen = n + "-open", this.classHeader = n + "-header", this.classBody = n + "-body", this.$element = H(t).first(), J(this.options, e), this.bindEvent()
    }
    var Et = {
        accordion: !1
    };
    ...
    function It(t) {
        this.$thRow = H(), this.$tdRows = H(), this.$thCheckbox = H(), this.$tdCheckboxs = H(), this.selectable = !1, this.selectedRow = 0, this.$element = H(t).first(), this.init()
    }
    It.prototype.init = function () {
        ...
        var t = this;
        this.$thRow.find(".mdui-table-cell-checkbox").remove(), this.selectable && (this.$thCheckbox = H(this.createCheckboxHTML("th")).prependTo(this.$thRow).find('input[type="checkbox"]').on("change", function () {
    ...
    function qt(t, e) {
        ...
        if (!(-1 < ["checkbox", "button", "submit", "range", "radio", "image"].indexOf(r))) {
            ...
            h && ((e.reInit || e.domLoadedEvent) && H('<div class="mdui-textfield-counter"><span class="mdui-textfield-counter-inputed"></span> / ' + h + "</div>").appendTo(a), a.find(".mdui-textfield-counter-inputed").text(s.length.toString())), (a.find(".mdui-textfield-helper").length || a.find(".mdui-textfield-error").length || h) && a.addClass("mdui-textfield-has-bottom")
        }
    }
    ...
    function Yt(t) {
        ...
        var a = H();
        r && (a = H("<span></span>"), i.empty().append(a)), t.data("_slider_$track", e), t.data("_slider_$fill", n), t.data("_slider_$thumb", i), t.data("_slider_$input", o), t.data("_slider_min", o.attr("min")), t.data("_slider_max", o.attr("max")), t.data("_slider_disabled", s), t.data("_slider_discrete", r), t.data("_slider_$thumbText", a), Wt(t)
    }
    H(function () {
        L.on("input focus blur", ".mdui-textfield-input", {
            useCapture: !0
        }, qt), L.on("click", ".mdui-textfield-expandable .mdui-textfield-icon", function () {
    ...
    H(function () {
        L.on("input change", Ut, function () {
            ...
            Lt(t) && (Bt(t), this.disabled || H(this).parent().addClass("mdui-slider-focus"))
        }), L.on(At, Ut, function (t) {
            Lt(t) && (this.disabled || H(this).parent().removeClass("mdui-slider-focus"))
        }), L.on(Rt, Ut, Bt), N.mutation(".mdui-slider", function () {
            Yt(H(this))
        })
    ...
    function Xt(t, e) {
        var n = this;
        void 0 === e && (e = {}), this.options = J({}, Vt), this.state = "closed", this.$element = H(t).first(), J(this.options, e), this.$btn = this.$element.find(".mdui-fab"), this.$dial = this.$element.find(".mdui-fab-dial"), this.$dialBtns = this.$dial.find(".mdui-fab"), "hover" === this.options.trigger && (this.$btn.on("touchstart mouseenter", function () {
            return n.open()
    ...
    function Kt(t, e) {
        var n = this;
        void 0 === e && (e = {}), this.$element = H(), this.options = J({}, Gt), this.size = 0, this.$selected = H(), this.$menu = H(), this.$items = H(), this.selectedIndex = 0, this.selectedText = "", this.selectedValue = "", this.state = "closed", this.$native = H(t).first(), this.$native.hide(), J(this.options, e), this.uniqueID = H.guid(), this.handleUpdate(), L.on("click touchstart", function (t) {
            var e = H(t.target);
    ...
    Kt.prototype.readjustMenu = function () {
        ...
        var a = [];
        this.$items = H(), this.$native.find("option").each(function (t, e) {
            var n = e.textContent || "",
                i = e.value,
                o = e.disabled,
                s = r.selectedValue === i;
        ...
        }), this.$selected = H('<span class="mdui-select-selected">' + this.selectedText + "</span>"), this.$element = H('<div class="mdui-select mdui-select-position-' + this.options.position + '" style="' + this.$native.attr("style") + '" id="' + this.uniqueID + '"></div>').show().append(this.$selected), this.$menu = H('<div class="mdui-select-menu"></div>').appendTo(this.$element).append(this.$items), H("#" + this.uniqueID).remove(), this.$native.after(this.$element), this.size = parseInt(this.$native.attr("size") || "0"), this.size <= 0 && (this.size = this.$items.length, 8 < this.size && (this.size = 8));
        var i = this;
    ...
    function Zt(t, e) {
        var n = this;
        void 0 === e && (e = {}), this.options = J({}, te), this.activeIndex = -1, this.$element = H(t).first(), J(this.options, e), this.$tabs = this.$element.children("a"), this.$indicator = H('<div class="mdui-tab-indicator"></div>').appendTo(this.$element);
        ...
        }), this.$tabs.length && -1 === this.activeIndex && (this.activeIndex = 0), this.setActive(), B.on("resize", H.throttle(function () {
    ...
    Zt.prototype.isDisabled = function (t) {
        ...
        this.$tabs.each(function (t, e) {
            var n = H(e),
                i = n.attr("href") || "";
            t !== o.activeIndex || o.isDisabled(n) ? (n.removeClass("mdui-tab-active"), H(i).hide()) : (n.hasClass("mdui-tab-active") || (o.triggerEvent("change", o.$element, {
                index: o.activeIndex,
                id: i.substr(1)
            }), o.triggerEvent("show", n), n.addClass("mdui-tab-active")), H(i).show(), o.setIndicatorPosition())
        })
        ...
        var i = this; - 1 !== this.activeIndex && (p(n) ? this.activeIndex = n : this.$tabs.each(function (t, e) {
    ...
    function ne(t, e) {
        var n = this;
        void 0 === e && (e = {}), this.options = J({}, ie), this.overlay = !1, this.$element = H(t).first(), J(this.options, e), this.position = this.$element.hasClass("mdui-drawer-right") ? "right" : "left", this.$element.hasClass("mdui-drawer-close") ? this.state = "closed" : this.$element.hasClass("mdui-drawer-open") || this.isDesktop() ? this.state = "opened" : this.state = "closed", B.on("resize", H.throttle(function () {
            n.isDesktop() ? (n.overlay && !n.options.overlay && (H.hideOverlay(), n.overlay = !1, H.unlockScreen()), n.$element.hasClass("mdui-drawer-close") || (n.state = "opened")) : n.overlay || "opened" !== n.state || (n.$element.hasClass("mdui-drawer-open") ? (H.showOverlay(), n.overlay = !0, H.lockScreen(), H(".mdui-overlay").one("click", function () {
                return n.close()
            })) : n.state = "closed")
    ...
    ne.prototype.isDesktop = function () {
        ...
        function p(t) {
            if (c) {
                ...
                l = !1;
                var i = c;
                c = null, "opening" === i ? n < .92 ? (o(), u.open()) : o() : .08 < n ? (o(), u.close()) : o(), H.unlockScreen()
            } else l = !1;
            P.off({
                touchmove: m,
                touchend: p,
        ...
        function m(t) {
            ...
            if (c) d(f(e));
                ...
                var i = Math.abs(e - s),
                    o = Math.abs(n - r);
                8 < i && o <= 8 ? (a = e, c = "opened" === u.state ? "closing" : "opening", H.lockScreen(), d(f(e))) : i <= 8 && 8 < o && p()
            }
        }

        function i(t) {
            s = t.touches[0].pageX, "right" === u.position && (s = P.width() - s), r = t.touches[0].pageY, "opened" !== u.state && (n < s || e !== i) || (l = !0, P.on({
                touchmove: m,
                touchend: p,
                touchcancel: m
            }))
        ...
        var t = this;
        this.isOpen() || (this.state = "opening", this.triggerEvent("open"), this.options.overlay || P.addClass("mdui-drawer-body-" + this.position), this.$element.removeClass("mdui-drawer-close").addClass("mdui-drawer-open").transitionEnd(function () {
            return t.transitionEnd()
        }), this.isDesktop() && !this.options.overlay || (this.overlay = !0, H.showOverlay().one("click", function () {
            return t.close()
        }), H.lockScreen()))
    }, ne.prototype.close = function () {
        var t = this;
        this.isOpen() && (this.state = "closing", this.triggerEvent("close"), this.options.overlay || P.removeClass("mdui-drawer-body-" + this.position), this.$element.addClass("mdui-drawer-close").removeClass("mdui-drawer-open").transitionEnd(function () {
            return t.transitionEnd()
        }), this.overlay && (H.hideOverlay(), this.overlay = !1, H.unlockScreen()))
    ...
    function ue(t, e) {
        var n = this;
        void 0 === e && (e = {}), this.options = J({}, le), this.state = "closed", this.append = !1, this.$element = H(t).first(), z(document.body, this.$element[0]) || (this.append = !0, P.append(this.$element)), J(this.options, e), this.$element.find("[mdui-dialog-cancel]").each(function (t, e) {
            H(e).on("click", function () {
    ...
    ue.prototype.triggerEvent = function (t) {
        ...
        this.$element.hasClass("mdui-dialog-open") ? (this.state = "opened", this.triggerEvent("opened")) : (this.state = "closed", this.triggerEvent("closed"), this.$element.hide(), re(he).length || de || !fe || (H.unlockScreen(), fe = !1), B.off("resize", H.throttle(this.readjust, 100)), this.options.destroyOnClosed && this.destroy())
    }, ue.prototype.doOpen = function () {
        var t = this;
        if (de = this, fe || (H.lockScreen(), fe = !0), this.$element.show(), this.readjust(), B.on("resize", H.throttle(this.readjust, 100)), this.state = "opening", this.triggerEvent("open"), this.$element.addClass("mdui-dialog-open").transitionEnd(function () {
                return t.transitionEnd()
            }), ce = ce || H.showOverlay(5100), this.options.modal ? ce.off("click", this.overlayClick) : ce.on("click", this.overlayClick), ce.css("opacity", this.options.overlay ? "" : 0), this.options.history) {
            var e = window.location.hash.substring(1); - 1 < e.indexOf("mdui-dialog") && (e = e.replace(/[&?]?mdui-dialog/g, "")), window.location.hash = e ? e + (-1 < e.indexOf("?") ? "&" : "?") + "mdui-dialog" : "mdui-dialog", B.on("hashchange", this.hashchangeEvent)
        }
        ...
        void 0 === t && (t = !1), setTimeout(function () {
            e.isOpen() && (de = null, e.state = "closing", e.triggerEvent("close"), !re(he).length && ce && (H.hideOverlay(), ce = null, H(".mdui-overlay").css("z-index", 2e3)), e.$element.removeClass("mdui-dialog-open").transitionEnd(function () {
                return e.transitionEnd()
            }), e.options.history && !re(he).length && (t || window.history.back(), B.off("hashchange", e.hashchangeEvent)), setTimeout(function () {
                ae(he)
            }, 100))
        })
        ...
        this.append && this.$element.remove(), re(he).length || de || (ce && (H.hideOverlay(), ce = null), fe && (H.unlockScreen(), fe = !1))
    ...
    var ve = {
        ...
        ye = {
            ...
            modal: !(N.dialog = function (n) {
                ...
                var i = "";
                null !== (t = n.buttons) && void 0 !== t && t.length && (i = '<div class="mdui-dialog-actions' + (n.stackedButtons ? " mdui-dialog-actions-stacked" : "") + '">', A(n.buttons, function (t, e) {
        ...
        be = {
            ...
            modal: !(N.alert = function (t, e, n, i) {
                return f(e) && (i = n, n = e, e = ""), O(n) && (n = function () {}), O(i) && (i = {}), i = J({}, ye, i), N.dialog({
                    title: e,
                    content: t,
                    buttons: [{
                        text: i.confirmText,
        ...
        xe = {
            ...
            modal: !(N.confirm = function (t, e, n, i, o) {
                return f(e) && (o = i, i = n, n = e, e = ""), O(n) && (n = function () {}), O(i) && (i = function () {}), O(o) && (o = {}), o = J({}, be, o), N.dialog({
                    title: e,
                    content: t,
                    buttons: [{
                        text: o.cancelText,
    ...
    N.prompt = function (t, e, i, n, o) {
        f(e) && (o = n, n = i, i = e, e = ""), O(i) && (i = function () {}), O(n) && (n = function () {}), O(o) && (o = {});
        ...
        return N.dialog({
            ...
            onOpen: function (n) {
                ...
                N.updateTextFields(t), t[0].focus(), "textarea" !== o.type && !0 === o.confirmOnEnter && t.on("keydown", function (t) {
                    if (13 === t.keyCode) {
    ...
    function Ce(t, e) {
        void 0 === e && (e = {}), this.options = J({}, we), this.state = "closed", this.timeoutId = null, this.$target = H(t).first(), J(this.options, e), this.$element = H('<div class="mdui-tooltip" id="' + H.guid() + '">' + this.options.content + "</div>").appendTo(document.body);
        var n = this;
    ...
    Ce.prototype.isDisabled = function (t) {
        ...
        switch ("auto" === r && (r = n.top + n.height + i + s + 2 < B.height() ? "bottom" : i + s + 2 < n.top ? "top" : i + o + 2 < n.left ? "left" : n.width + i + o + 2 < B.width() - n.left ? "right" : "bottom"), r) {
            case "bottom":
        ...
        if (!this.isOpen()) {
            ...
            t && J(this.options, t), n.content !== this.options.content && this.$element.html(this.options.content), this.setPosition(), this.options.delay ? this.timeoutId = setTimeout(function () {
                return e.doOpen()
    ...
    function Oe(t) {
        this.options = J({}, ke), this.state = "closed", this.timeoutId = null, J(this.options, t);
        var e = "",
            n = "";
    ...
    Oe.prototype.closeOnOutsideClick = function (t) {
        ...
        "opening" !== this.state && "opened" !== this.state && (_e ? re(Te, function () {
            ...
            }), e.options.closeOnOutsideClick && L.on(jt, e.closeOnOutsideClick), e.options.timeout && (e.timeoutId = setTimeout(function () {
                return e.close()
            }, e.options.timeout)))
        })))
    }, Oe.prototype.close = function () {
        var t = this;
        "closing" !== this.state && "closed" !== this.state && (this.timeoutId && clearTimeout(this.timeoutId), this.options.closeOnOutsideClick && L.off(jt, this.closeOnOutsideClick), this.state = "closing", this.options.onClose(this), this.setPosition("close"), this.$element.transitionEnd(function () {
    ...
    function je(t, e, n) {
        var i = this;
        if (void 0 === n && (n = {}), this.options = J({}, Me), this.state = "closed", this.$anchor = H(t).first(), this.$element = H(e).first(), !this.$anchor.parent().is(this.$element.parent())) throw new Error("anchorSelector and menuSelector must be siblings");
        J(this.options, n), this.isCascade = this.$element.hasClass("mdui-menu-cascade"), this.isCovered = "auto" === this.options.covered ? !this.isCascade : this.options.covered, this.$anchor.on("click", function () {
            return i.toggle()
        ...
        }), this.bindSubMenuEvent(), B.on("resize", H.throttle(function () {
            return i.readjust()
        }, 100))
    }
    var Me = {
